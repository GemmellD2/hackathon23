...
export function NavbarWithSearch() {
  ...
  return (
    <Navbar className="rounded-none max-w-none mx-auto px-4 py-2 lg:px-0 lg:py-4">
      <div className="container w-4/5 max-w-screen-2xl mx-auto flex flex-wrap items-center justify-between text-blue-gray-900">
